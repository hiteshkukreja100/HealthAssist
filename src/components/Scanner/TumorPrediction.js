...
function TumorPrediction() {
  ...
  return (
    <div style={{ textAlign: 'center', maxWidth: '800px', margin: '0 auto' }}>
      <h2 style={{ color: '#333', marginBottom: '20px' }}>MRI Scan Tumor Prediction</h2>
      <div style={{ marginBottom: '20px', textAlign: 'left' }}>
        <p style={{ fontSize: '16px', marginBottom: '10px' }}>
          An MRI scan is a medical imaging technique used to visualize internal structures of the body.
          It is particularly useful in identifying abnormalities such as tumors in the brain.
        </p>
        <p style={{ fontSize: '16px', marginBottom: '10px' }}>
          Please upload an MRI scan image below for tumor prediction.
        </p>
      </div>
